...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initBankProfiles() {
        // 1금융권은 정부 정책대출(디딤돌·보금자리론·신생아특례 등) 취급, 상호금융은 자체 상품
        Object[][] profiles = {
            ...
            {"부산은행",
             ...
             "02-1588-6200"},
            {"대구은행",
             "대구은행(iM뱅크) 입주잔금팀입니다. 대구·경북 지역 단지 전문 상담드립니다.",
             "▣ 정부 정책대출\n  · 디딤돌대출\n  · 보금자리론\n  · 신생아 특례 디딤돌대출\n\n▣ 자체 상품\n  · 잔금대출, iM뱅크 연계\n  · 지역 우대 상품",
             "평일 09:00~18:00",
             "02-1588-5050"},
            // ─── 상호금융 (DSR 50%) ───
            {"새마을금고",
             "새마을금고 입주ON 전담팀입니다. DSR 50% 한도로 더 많은 자금 마련을 도와드립니다.",
             "▣ 정부 정책대출\n  · 디딤돌대출 (취급 가능)\n  · 보금자리론 (취급 가능)\n  · 신생아 특례 디딤돌대출\n\n▣ 자체 상품\n  · MG 잔금대출 (DSR 50% 한도)\n  · MG 우대대출, 한도 우대",
             "평일 09:00~18:00",
             "1599-9000"},
            {"지역농협",
             "지역농협 입주잔금팀입니다. 농업인·청년 우대 상품으로 폭넓게 도와드립니다.",
             "▣ 정부 정책대출\n  · 디딤돌대출\n  · 보금자리론\n  · 신생아 특례 디딤돌대출\n\n▣ 자체 상품\n  · 잔금대출 (DSR 50% 한도)\n  · 농업인·청년 우대 상품",
             "평일 09:00~18:00",
             "1588-2100"},
            {"신협",
             "신협 입주ON 전담팀입니다. 조합원 우대 + DSR 50% 한도로 도와드립니다.",
             "▣ 정부 정책대출\n  · 보금자리론 (취급 가능)\n  · 신생아 특례 (조합 따라 다름)\n\n▣ 자체 상품\n  · 신협 잔금대출 (DSR 50%)\n  · 조합원 우대대출, 출자금 연계",
             "평일 09:00~18:00 (지역 조합 따라 다름)",
             "1566-6000"},
            {"산림조합",
             "산림조합 입주ON 전담팀입니다. 임업인 우대 + DSR 50% 한도 상품 안내드립니다.",
             "▣ 정부 정책대출\n  · 보금자리론 (취급 가능)\n\n▣ 자체 상품\n  · 산림조합 잔금대출 (DSR 50%)\n  · 임업인 우대 상품",
             "평일 09:00~18:00",
             "1600-0003"},
        };
